...
# Only standing error is at 189, data type error where 'w' is being set as 'none' somewhere above.
# Tried tracing it, but either I'm too tired or too braindead to see what I did wrong
# Traced from getWarn to warnInteger. warnint is a lot of spaghetti though. Likely math related error

# Doesnt always trip error, either. Seems to be a thing that happens when my white space reveal functionality tries to reveal a bomb
...
def resetGame() :
	global fps, boxes, numBombs, flagsUsed, checkedBoxes, blocksLeft
	fps = pygame.time.Clock()
	boxes[:] = []
	numBombs = 0
	drawBoxesInit()
